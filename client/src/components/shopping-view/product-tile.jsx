...
function ShoppingProductTile({
  ...
  return (
    <Card className="w-full sm:max-w-xs md:max-w-sm lg:max-w-md mx-auto">
      <div onClick={() => handleGetProductDetails(product?._id)} className="cursor-pointer">
        <div className="relative">
          <img
            src={product?.image}
            alt={product?.title}
            className="w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[350px] object-cover rounded-t-lg"
          />
          {product?.totalStock === 0 ? (
        ...
        <CardContent className="p-3 sm:p-4">
          ...
          <div className="flex justify-between items-center mb-2 text-[12px] sm:text-[14px]">
